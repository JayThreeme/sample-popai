  ...
  <div className="flex items-center gap-1">
    ...
    <div className="w-[76.93px] h-[40.84px]">
      <svg viewBox="0 0 76.9296 40.8362" fill="none" className="w-full h-full">
        <defs>
          <linearGradient id="pop_gradient" x1="32.77" y1="42.6" x2="55.33" y2="40.81" gradientUnits="userSpaceOnUse">
...
const FooterColumn = ({ title, links }) => (
  <div className="flex flex-col gap-6 items-center md:items-start text-center md:text-left">
    ...
    <ul className="flex flex-col gap-3">
      {links.map((link) => (
        <li key={link}>
          <a href="#" className="font-inter font-extralight text-base text-[#d4d4d4] hover:text-white transition-colors">
            {link}
          </a>
        </li>
      ))}
...
export function Footer() {
  return (
    <footer className="bg-[#0a0a0a] pt-16 pb-8 px-6 md:px-12 border-t border-[#1a1a1a]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 md:gap-0">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 md:gap-6 max-w-[260px] text-center md:text-left">
            ...
            <p className="font-inter font-extralight text-base text-[#d4d4d4] leading-relaxed">
              Secure, adaptable intelligence that scales with your business on your terms, anywhere you need it.
            </p>
            <a href="mailto:contact@popai.agency" className="font-inter font-normal text-base text-[#d4d4d4] hover:text-white transition-colors">
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-16">
            <FooterColumn 
              title="Product" 
              links={["Overview", "AgentiX™", "PopApps™", "Opera™", "Ai Agents"]} 
            />
            <FooterColumn 
              title="Company" 
            ...
            <FooterColumn 
              title="Resources" 
              links={["Overview", "Blog", "Case Study", "Brochure", "Press Release", "Events"]} 
            />
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-8 md:gap-0 border-t border-transparent md:border-transparent pt-0">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
            ...
            <div className="flex items-center gap-6">
              {/* Facebook */}
              <SocialIcon>
                <svg viewBox="0 0 14.007 24.2401" fill="none" className="h-6 w-auto">
                  <path d={svgPaths.p16bd4000} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </SocialIcon>
              
              {/* X / Twitter */}
              <SocialIcon>
                <svg viewBox="0 0 27.2881 27.2881" fill="none" className="h-6 w-auto">
                   ...
                   <svg viewBox="0 0 16 16" fill="none" className="w-full h-full">
                      ...
                      */}
                      <g transform="scale(0.9)">
                        <path d={svgPaths.p87d5880} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d={svgPaths.pe66e500} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" transform="translate(2, 0)"/> {/* Adjusting position based on separate viewboxes in original code might be tricky. Let's try to map them to a single viewBox or just use lucide for standard icons if this fails visually. But user wants specific SVGs. 
            ...
            <div className="flex items-center gap-6">
              {["Terms", "Privacy", "Cookies"].map((text) => (
                <a key={text} href="#" className="font-inter font-extralight text-sm text-[#d4d4d4] hover:text-white transition-colors">
                  {text}
                </a>
              ))}
            </div>
